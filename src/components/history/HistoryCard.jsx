...
// Kept in sync with the same map used in dashboard/RecentAnalysisCard.jsx.
...
// Formats the time-of-day shown alongside the date within a group,
// e.g. "9:41 AM".
...
// Specialty icon — same generic report icon used across dashboard + history.
// Per-specialty icons are a future enhancement, not part of this milestone.
...
// A single row in the History screen's analysis list.
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between gap-2 mt-2">
            ...
            <p className="text-xs text-text-secondary ml-auto shrink-0 font-mono">
